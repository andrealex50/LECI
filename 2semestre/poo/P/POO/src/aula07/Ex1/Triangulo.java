...
public class Triangulo extends Forma {
    ...
    public String toString() {
        return "Triângulo de lados " + lado1 + ", " + lado2 + ", " + lado3 + " com área " + getArea() + " e perímetro " + getPerimetro() + " de cor " + getColor();
    }

    public static boolean equals(Triangulo Triangulo1, Triangulo Triangulo2) {
        if (Triangulo1.lado1 == Triangulo2.lado1 && Triangulo1.lado2 == Triangulo2.lado2 && Triangulo1.lado3 == Triangulo2.lado3 && Triangulo1.getColor().equals(Triangulo2.getColor())) {
            return true;
        }
        return false;
    }
