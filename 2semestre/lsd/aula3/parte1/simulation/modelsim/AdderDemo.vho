...
SIGNAL \inst3|bit0|cout~0_combout\ : std_logic;
...
SIGNAL \inst3|bit3|s~0_combout\ : std_logic;
SIGNAL \inst3|bit2|s~0_combout\ : std_logic;
SIGNAL \inst3|bit1|s~combout\ : std_logic;
...
\inst3|bit0|cout~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|bit0|cout~0_combout\ = (\SW[10]~input_o\ & (\SW[14]~input_o\)) # (!\SW[10]~input_o\ & ((\KEY[0]~input_o\)))
...
PORT MAP (
	...
	datac => \SW[10]~input_o\,
	datad => \KEY[0]~input_o\,
	combout => \inst3|bit0|cout~0_combout\);
...
-- Equation(s):
-- \inst3|bit1|cout~0_combout\ = (\SW[15]~input_o\ & ((\inst3|bit0|cout~0_combout\) # (\SW[11]~input_o\ $ (\KEY[0]~input_o\)))) # (!\SW[15]~input_o\ & (\inst3|bit0|cout~0_combout\ & (\SW[11]~input_o\ $ (\KEY[0]~input_o\))))
...
PORT MAP (
	dataa => \SW[15]~input_o\,
	datab => \inst3|bit0|cout~0_combout\,
	datac => \SW[11]~input_o\,
	datad => \KEY[0]~input_o\,
...
-- Equation(s):
-- \inst3|bit2|cout~0_combout\ = (\inst3|bit1|cout~0_combout\ & ((\SW[16]~input_o\) # (\SW[12]~input_o\ $ (\KEY[0]~input_o\)))) # (!\inst3|bit1|cout~0_combout\ & (\SW[16]~input_o\ & (\SW[12]~input_o\ $ (\KEY[0]~input_o\))))
...
-- Equation(s):
-- \inst3|bit3|cout~0_combout\ = (\inst3|bit2|cout~0_combout\ & ((\SW[17]~input_o\) # (\SW[13]~input_o\ $ (\KEY[0]~input_o\)))) # (!\inst3|bit2|cout~0_combout\ & (\SW[17]~input_o\ & (\SW[13]~input_o\ $ (\KEY[0]~input_o\))))
...
\inst3|bit3|s~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|bit3|s~0_combout\ = \inst3|bit2|cout~0_combout\ $ (\SW[13]~input_o\ $ (\SW[17]~input_o\ $ (\KEY[0]~input_o\)))
...
PORT MAP (
	...
	datac => \SW[17]~input_o\,
	datad => \KEY[0]~input_o\,
	combout => \inst3|bit3|s~0_combout\);

-- Location: LCCOMB_X109_Y16_N26
\inst3|bit2|s~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|bit2|s~0_combout\ = \SW[12]~input_o\ $ (\inst3|bit1|cout~0_combout\ $ (\SW[16]~input_o\ $ (\KEY[0]~input_o\)))
...
\inst3|bit1|s\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|bit1|s~combout\ = \SW[15]~input_o\ $ (\inst3|bit0|cout~0_combout\ $ (\SW[11]~input_o\ $ (\KEY[0]~input_o\)))
...
PORT MAP (
	...
	datac => \SW[11]~input_o\,
	datad => \KEY[0]~input_o\,
	combout => \inst3|bit1|s~combout\);

-- Location: LCCOMB_X109_Y16_N22
\inst3|bit0|s~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst3|bit0|s~0_combout\ = \SW[10]~input_o\ $ (\SW[14]~input_o\)
