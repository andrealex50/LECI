...
-- Equation(s):
-- \inst|decOut_n[6]~0_combout\ = (\SW[3]~input_o\ & (((\SW[1]~input_o\) # (!\SW[2]~input_o\)))) # (!\SW[3]~input_o\ & (\SW[2]~input_o\ $ (((\SW[0]~input_o\ & \SW[1]~input_o\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1011010111101010",
...
-- Equation(s):
-- \inst|decOut_n~4_combout\ = (\SW[3]~input_o\ & (\SW[2]~input_o\ & ((\SW[1]~input_o\) # (!\SW[0]~input_o\))))
