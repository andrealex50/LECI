...
-- Equation(s):
-- \inst|muxOut~0_combout\ = (\KEY[0]~input_o\ & (((\SW[1]~input_o\) # (\KEY[1]~input_o\)))) # (!\KEY[0]~input_o\ & (\SW[0]~input_o\ & ((!\KEY[1]~input_o\))))
...
-- Equation(s):
-- \inst|muxOut~1_combout\ = (\inst|muxOut~0_combout\ & ((\SW[3]~input_o\) # ((!\KEY[1]~input_o\)))) # (!\inst|muxOut~0_combout\ & (((\SW[2]~input_o\ & \KEY[1]~input_o\))))
