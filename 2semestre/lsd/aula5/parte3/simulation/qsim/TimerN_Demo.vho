...
SIGNAL \s_count[0]~42_combout\ : std_logic;
...
-- Equation(s):
-- \s_count[0]~41_combout\ = (\Equal0~9_combout\ & (!\reset~input_o\ & (!s_count(3) & !\start~input_o\)))
...
\s_count[0]~42\ : cycloneive_lcell_comb
-- Equation(s):
-- \s_count[0]~42_combout\ = (!\s_count[0]~41_combout\ & ((\reset~input_o\) # (\enable~input_o\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \s_count[0]~41_combout\,
	datac => \reset~input_o\,
	datad => \enable~input_o\,
	combout => \s_count[0]~42_combout\);
...
PORT MAP (
	...
	sclr => \s_count[0]~40_combout\,
	ena => \s_count[0]~42_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => s_count(4));
...
-- Equation(s):
-- \Equal0~0_combout\ = (!s_count(0) & (!s_count(1) & (!s_count(2) & !s_count(4))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!s_count(5) & (!s_count(6) & (!s_count(7) & !s_count(8))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (!s_count(9) & (!s_count(10) & (!s_count(11) & !s_count(12))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (!s_count(13) & (!s_count(14) & (!s_count(15) & !s_count(16))))
...
-- Equation(s):
-- \Equal0~5_combout\ = (!s_count(17) & (!s_count(18) & (!s_count(19) & !s_count(20))))
...
-- Equation(s):
-- \Equal0~6_combout\ = (!s_count(21) & (!s_count(22) & (!s_count(23) & !s_count(24))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (!s_count(25) & (!s_count(26) & (!s_count(27) & !s_count(28))))
...
-- Equation(s):
-- \Equal0~8_combout\ = (\Equal0~7_combout\ & (!s_count(29) & (!s_count(30) & !s_count(31))))
...
-- Equation(s):
-- \s_count[0]~40_combout\ = (\reset~input_o\) # ((\Equal0~9_combout\ & ((s_count(3)) # (!\start~input_o\))))
...
-- Equation(s):
-- \timerOut~0_combout\ = (\enable~input_o\ & (s_count(3) & (\Equal0~9_combout\ & !\reset~input_o\)))
...
-- Equation(s):
-- \timerOut~1_combout\ = (\timerOut~0_combout\) # ((\timerOut~reg0_q\ & (!\reset~input_o\ & !\enable~input_o\)))
