...
-- pragma translate_on
PORT MAP (
	i => \inst5|ALT_INV_Equal0~1_combout\,
	devoe => ww_devoe,
	o => \LEDR[1]~output_o\);
...
-- Equation(s):
-- \inst5|LessThan1~2_combout\ = (\SW[9]~input_o\ & (((!\SW[13]~input_o\ & \SW[8]~input_o\)) # (!\SW[14]~input_o\))) # (!\SW[9]~input_o\ & (!\SW[13]~input_o\ & (\SW[8]~input_o\ & !\SW[14]~input_o\)))
...
-- Equation(s):
-- \inst5|LessThan1~1_combout\ = (\SW[17]~input_o\ & (\SW[12]~input_o\ & (\SW[11]~input_o\ $ (!\SW[16]~input_o\)))) # (!\SW[17]~input_o\ & (!\SW[12]~input_o\ & (\SW[11]~input_o\ $ (!\SW[16]~input_o\))))
...
-- Equation(s):
-- \inst5|LessThan1~3_combout\ = (\inst5|LessThan1~1_combout\ & ((\inst5|LessThan1~2_combout\ & ((\SW[10]~input_o\) # (!\SW[15]~input_o\))) # (!\inst5|LessThan1~2_combout\ & (!\SW[15]~input_o\ & \SW[10]~input_o\))))
...
-- Equation(s):
-- \inst5|LessThan1~0_combout\ = (\SW[11]~input_o\ & (!\SW[16]~input_o\ & (\SW[17]~input_o\ $ (!\SW[12]~input_o\))))
...
-- Equation(s):
-- \inst5|LessThan1~4_combout\ = (\inst5|LessThan1~3_combout\) # ((\inst5|LessThan1~0_combout\) # ((\SW[12]~input_o\ & !\SW[17]~input_o\)))
...
-- Equation(s):
-- \inst5|LessThan0~0_combout\ = (\inst5|LessThan1~3_combout\) # ((\inst5|LessThan1~0_combout\) # ((!\SW[12]~input_o\ & \SW[17]~input_o\)))
...
-- Equation(s):
-- \inst5|Equal0~0_combout\ = (\SW[13]~input_o\ & (\SW[8]~input_o\ & (\SW[9]~input_o\ $ (!\SW[14]~input_o\)))) # (!\SW[13]~input_o\ & (!\SW[8]~input_o\ & (\SW[9]~input_o\ $ (!\SW[14]~input_o\))))
...
-- Equation(s):
-- \inst5|Equal0~1_combout\ = (\inst5|LessThan1~1_combout\ & (\inst5|Equal0~0_combout\ & (\SW[10]~input_o\ $ (!\SW[15]~input_o\))))
