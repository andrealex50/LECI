...
-- Equation(s):
-- \andOut~0_combout\ = (\input0~input_o\ & \input1~input_o\)
...
-- Equation(s):
-- \orOut~0_combout\ = (\input0~input_o\) # (\input1~input_o\)
...
-- Equation(s):
-- \xorOut~0_combout\ = \input0~input_o\ $ (\input1~input_o\)
